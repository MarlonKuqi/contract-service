...
import com.mk.contractservice.application.client.usecase.PatchClientUseCase.PatchClientCommand;
...
class PatchClientUseCaseImplTest {
    ...
    @InjectMocks
    private PatchClientUseCaseImpl patchClientUseCase;
    ...
    class ExecuteHappyPath {
        ...
        void shouldUpdateOnlyNameWhenOnlyNameProvided() {
            ...
            // Then
            assertThat(result.getName().value()).isEqualTo("New Name");
            assertThat(result.getEmail().value()).isEqualTo(originalEmail);
            assertThat(result.getPhone().value()).isEqualTo(originalPhone);
            verify(clientRepository).save(any(Client.class));
        }
        ...
        void shouldUpdateOnlyEmailWhenOnlyEmailProvided() {
            ...
            // Then
            assertThat(result.getName().value()).isEqualTo(originalName);
            assertThat(result.getEmail().value()).isEqualTo("new@example.com");
            assertThat(result.getPhone().value()).isEqualTo(originalPhone);
            verify(clientRepository).save(any(Client.class));
        }
    ...
    class ExecuteNoChanges {
        ...
        void shouldRetrieveClientButNotSaveWhenNoChanges() {
            ...
            PatchClientCommand command = new PatchClientCommand(clientId, null, null, null);
    ...
    class ExecuteValidationErrors {
        ...
        void shouldThrowExceptionWhenClientNotFound() {
            ...
            // When & Then
            assertThatThrownBy(() -> patchClientUseCase.execute(command))
