package com.mk.contractservice.web.client.dto;
...
public record CreatePersonRequest(
        ...
        @Schema(description = "Person clientEmail address", example = "alice.martin@example.com", format = "email", maxLength = 254, requiredMode = Schema.RequiredMode.REQUIRED)
        String email,
