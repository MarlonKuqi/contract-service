...
import com.mk.contractservice.application.contract.usecase.UpdateContractCostUseCase.UpdateContractCostCommand;
...
class UpdateContractCostUseCaseImplTest {
    ...
    @InjectMocks
    private UpdateContractCostUseCaseImpl updateContractCostUseCase;
    ...
    class ExecuteHappyPath {
        ...
        void shouldUpdateContractCost() {
            ...
            UpdateContractCostCommand command = new UpdateContractCostCommand(
                    clientId,
                    contractId,
                    newCost
            );
    ...
    class ExecuteValidationErrors {
        ...
        void shouldThrowExceptionWhenContractDoesNotExist() {
            ...
            // When & Then
            assertThatThrownBy(() -> updateContractCostUseCase.execute(command))
