...
public class HexagonalArchitectureTest {
    ...
    private final DescribedPredicate<JavaClass> areWeb = resideInAnyPackage("com.mk.contractservice.web..");
    ...
    @Test
    void application_should_not_depend_on_web() {
        noClasses()
                .that(areApplication)
                .should()
                .dependOnClassesThat(areWeb)
